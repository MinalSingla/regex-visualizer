...
function ZoomBar(props) {
  ...
  var btnS = {
    background: 'var(--hl)', border: '1px solid var(--border)', color: 'var(--text)',
  ...
  return React.createElement('div', {
    ...
    React.createElement('span', {
      style: {
        ...
        color: 'var(--muted)', minWidth: 34, textAlign: 'center'
      }
    }, Math.round(zoom * 100) + '%'),
...
function App() {
  ...
  return (
    React.createElement(
        'div',
        { __self: this, __source: { fileName: _jsxFileName, lineNumber: 1306 } },
        ...
        , React.createElement('div', { className: "left", __self: this, __source: { fileName: _jsxFileName, lineNumber: 1345 } }
          ...
          , isNfaTab && nfaSteps.length > 0 && (
            React.createElement('div', { className: "snav", __self: this, __source: { fileName: _jsxFileName, lineNumber: 1520 } }
              , React.createElement('button', {
                className: "nb", disabled: nfaIdx <= 0,
                onClick: function () { setIsPlaying(false); setNfaIdx(function (i) { return i - 1; }); }, __self: this, __source: { fileName: _jsxFileName, lineNumber: 1521 }
              }, "← Prev")
              , React.createElement('button', {
                className: "nb", style: { borderColor: isPlaying ? 'var(--a2)' : 'var(--a3)', color: isPlaying ? 'var(--a2)' : 'var(--a3)', minWidth: '60px' },
                onClick: function () { setIsPlaying(function (p) { return !p; }); }, __self: this, __source: { fileName: _jsxFileName, lineNumber: 1522 }
              ...
              , React.createElement('button', {
                className: "nb", disabled: nfaIdx >= nfaSteps.length,
                onClick: function () { setIsPlaying(false); setNfaIdx(function (i) { return i + 1; }); }, __self: this, __source: { fileName: _jsxFileName, lineNumber: 1524 }
              }, "Next →")
            )
          )
          , isDfaTab && dfaData && dfaData.steps.length > 0 && (
            React.createElement('div', { className: "snav", __self: this, __source: { fileName: _jsxFileName, lineNumber: 1529 } }
              , React.createElement('button', {
                className: "nb dfa", disabled: dfaIdx <= 0,
                onClick: function () { setIsPlaying(false); setDfaIdx(function (i) { return i - 1; }); }, __self: this, __source: { fileName: _jsxFileName, lineNumber: 1530 }
              }, "← Prev")
              , React.createElement('button', {
                className: "nb", style: { borderColor: isPlaying ? 'var(--a2)' : 'var(--a3)', color: isPlaying ? 'var(--a2)' : 'var(--a3)', minWidth: '60px' },
                onClick: function () { setIsPlaying(function (p) { return !p; }); }, __self: this, __source: { fileName: _jsxFileName, lineNumber: 1531 }
              }, isPlaying ? '⏸ Pause' : '▶ Play')
              ...
              , React.createElement('button', {
                className: "nb dfa", disabled: dfaIdx >= dfaData.steps.length - 1,
                onClick: function () { setIsPlaying(false); setDfaIdx(function (i) { return i + 1; }); }, __self: this, __source: { fileName: _jsxFileName, lineNumber: 1533 }
              }, "Next →")
            )
          )
          , isMinTab && minDfaData && minDfaData.steps.length > 0 && (
            React.createElement('div', { className: "snav", __self: this, __source: { fileName: _jsxFileName, lineNumber: 1538 } }
              , React.createElement('button', {
                className: "nb", style: { borderColor: 'var(--a4)', color: 'var(--a4)' }, disabled: minDfaIdx <= 0,
                onClick: function () { setIsPlaying(false); setMinDfaIdx(function (i) { return i - 1; }); }, __self: this, __source: { fileName: _jsxFileName, lineNumber: 1539 }
              }, "← Prev")
              , React.createElement('button', {
                className: "nb", style: { borderColor: isPlaying ? 'var(--a2)' : 'var(--a3)', color: isPlaying ? 'var(--a2)' : 'var(--a3)', minWidth: '60px' },
                onClick: function () { setIsPlaying(function (p) { return !p; }); }, __self: this, __source: { fileName: _jsxFileName, lineNumber: 1540 }
              }, isPlaying ? '⏸ Pause' : '▶ Play')
              ...
              , React.createElement('button', {
                className: "nb", style: { borderColor: 'var(--a4)', color: 'var(--a4)' }, disabled: minDfaIdx >= minDfaData.steps.length - 1,
                onClick: function () { setIsPlaying(false); setMinDfaIdx(function (i) { return i + 1; }); }, __self: this, __source: { fileName: _jsxFileName, lineNumber: 1542 }
              }, "Next →")
            )
          )
        )
